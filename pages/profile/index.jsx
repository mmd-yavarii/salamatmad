...
import { FiPhone, FiPackage, FiHeadphones, FiClock, FiChevronLeft, FiLogOut, FiSettings } from 'react-icons/fi';
...
export default function ProfilePage() {
    ...
    const isAdmin = auth.auth?.info?.role === 'admin';
    ...
    const menuItems = [
        ...
        {
            title: t('profile.menu.admin.title'),

            description: t('profile.menu.admin.description'),
        ...
        >
            ...
            <Dialog open={openLogout} onClose={() => setOpenLogout(false)}>
                ...
                <DialogActions sx={{ gap: 1 }}>
                    <Button variant="outlined" onClick={() => setOpenLogout(false)}>
